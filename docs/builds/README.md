...
| [0003](0003-ssh-cutover-retry.md) | SSH cutover retry | 2026-09-04 → 2026-09-04 | 13 | **Succeeded.** Full runbook proven end to end for the first time; Phase E's push-gate held under real conditions. `fix/` share 31%, down from 0002's 80%. |
